    ...
    <main>
      ...
      <section className="hero print-cover" id="home">
        ...
        <div className="hero-stats" aria-label="Company highlights">
          <div><StatsValue value="1994" /><span className="stat-label">Established</span></div><div><StatsValue value="30+" /><span className="stat-label">Years of operation</span></div><div><StatsValue value="8" /><span className="stat-label">Licensed activities</span></div><div><StatsValue value="25+" /><span className="stat-label">Recorded fleet</span></div>
        </div>
      </section>
      ...
      <section className="projects-section section-shell print-page" id="projects">
        ...
        <div className="split-heading"><div><p className="section-kicker">Selected experience</p><h2>Documented work.<br /><span>Defined scope.</span></h2></div><p>Explore PMTE’s demolition, earthworks and marine projects across Abu Dhabi and Al Ain.</p></div>
      ...
      <section className="clients-section" id="clients"><div className="section-shell">
        ...
        <div className="split-heading light-heading"><div><p className="section-kicker">Past client portfolio</p><h2>Trusted across<br /><span>Abu Dhabi.</span></h2></div><p>PMTE’s past clients span healthcare, media, real estate and investment in Abu Dhabi.</p></div>
      ...
      <section className="assurance-section print-page" id="hse"><div className="section-shell">
        ...
        <div className="split-heading light-heading"><div><p className="section-kicker">Three operating pillars</p><h2>Control risk.<br /><span>Protect outcomes.</span></h2></div><p>PMTE’s policies cover health and safety, environmental responsibility and quality management.</p></div>
      ...
      <section className="credentials-section section-shell print-page" id="credentials">
        ...
        <div className="split-heading"><div><p className="section-kicker">Credential register</p><h2>Current status.<br /><span>Clear dates.</span></h2></div><p>Company licences, memberships and permits, with issue and expiry dates.</p></div>
