...
export default function GalleryPage() {
  return <main className="route-page"><StickyNav alwaysSolid /><section className="gallery-section section-shell route-intro"><div className="section-index">Project gallery</div><div className="split-heading"><div><p className="section-kicker">Project archive</p><h1>Evidence from<br /><span>the field.</span></h1></div><p>Explore photographs of PMTE’s demolition, earthworks, marine works and equipment.</p></div><Gallery /></section></main>;
}
